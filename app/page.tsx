                ...
                <div className="flex flex-col-reverse justify-center mt-8 xl:flex-row xl:mt-32">
                    <div className="space-y-12 xl:w-1/2">
                        ...
                        <div className="flex justify-center md:justify-start xl:ml-4 space-x-4" id="about">
                            <Link href="/contact" className="hover:bg-sky-300 rounded-xl w-32 py-2 xl:w-40 text-sm xl:text-lg text-center px-4 xl:py-1 drop-shadow-lg border-2 border-slate-950 bg-gradient-to-r from-blue-500 to-sky-300" >Contate-me</Link>
                            <Link href="/contact" className="hover:bg-sky-300 rounded-xl w-32 py-2 xl:w-40 text-sm xl:text-lg text-center px-4 xl:py-1 drop-shadow-lg border-2 border-sky-300" >Baixar CV</Link>
                        </div>
                    </div>
