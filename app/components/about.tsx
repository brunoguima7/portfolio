                    ...
                    <div className="space-y-4 md:space-y-12 xl:w-2/5">
                        ...
                        <div className="flex flex-col-reverse md:flex-row">
                            <div className="flex justify-center md:justify-start xl:ml-4 space-x-4 mt-12 md:mt-0" id="about">
                                <Link href="/contact" className="hover:brightness-90 rounded-xl w-32 py-2 xl:w-36 text-sm xl:text-lg text-center px-4 xl:py-1 drop-shadow-lg border-2 border-slate-950 bg-gradient-to-r from-blue-500 to-sky-300" >Contate-me</Link>
